""" 
In this sample, the Flask app object is contained within the beatnick66_flask *module*;
that is, sites contains an __init__.py along with relative imports. Because
